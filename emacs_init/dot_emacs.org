...
#+begin_src emacs-lisp
  (use-package lsp-pyright
    ...
    ;; :hook (python-mode . (lambda ()
                           ;; (require 'lsp-pyright)
                           ;; (lsp-deferred)))  ;; start LSP just for Python
    :config
    ...
    (lsp-dependency
     'pyright
     '(:system "~/.venvs/pyright-venv/bin/pyright"))
    ;; Use pyright inside your virtual environment
    (setq lsp-pyright-langserver-command
          (list
           (expand-file-name "~/.venvs/pyright-venv/bin/pyright")
           "langserver"
           "--stdio"))
    ;; ensure Python interpreter follows project venvs
