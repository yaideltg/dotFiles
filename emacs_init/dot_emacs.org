...
[[https://github.com/Silex/docker.el][Docker package]] for Emacs, like Magit for Git.

Note: I'm getting an error saying package =docker= is not found ????
...
#+begin_src emacs-lisp
  ...
  (use-package apptainer-mode
    ...
    ;; Configure lsp-mode to ignore apptainer-mode
